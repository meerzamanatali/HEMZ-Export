...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Luxury Textiles Export Co.", url: "https://luxurytextiles.com" }],
  creator: "Luxury Textiles Export Co.",
  publisher: "Luxury Textiles Export Co.",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              address: {
                "@type": "PostalAddress",
                streetAddress: "Export House, Lal Chowk",
              ...
              contactPoint: {
                "@type": "ContactPoint",
                telephone: "+91-194-2501234",
                contactType: "sales",
                email: "export@luxurytextiles.com",
