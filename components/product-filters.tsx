...
const productTypes = ["Shawl", "Pashmina", "Scarf"]
const colors = ["Ivory", "Burgundy", "Navy", "Gold", "Black", "Grey", "Beige"]
const availabilityOptions = ["InStock", "OutOfStock"]
const materials = ["100% Pure Cashmere", "100% Pure Pashmina", "Cashmere with Silk Embroidery"]

export function ProductFilters({ onFilterChange, onSortChange }: FilterProps) {
              ...
              <div className="space-y-2">
                {materials.map((material) => (
                  <div key={material} className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor={`material-${material}`} className="text-sm text-xs">
                      {material}
                    </Label>
                  </div>
                ))}
